        ...
        <div className='container'>
          <ul className="list-group">
            <li className="list-group-item d-flex">
              <img className="server-img" src={portalImage} alt="Card image cap"/>
              <div className='server-name'>
                <div className='server-name-title'>Magic server one</div>
                <p>A place to serve magic</p>
              </div>
              <div className='server-stat'><i className="fas fa-user"></i>2/8</div>
              <div className='server-stat'><i className="fas fa-toggle-on"></i>3</div>
            </li>
            <li className="list-group-item d-flex">
              <img className="server-img" src={mushroomImage} alt="Card image cap"/>
              <div className='server-name'>
            ...
            <li className="list-group-item d-flex">
              <img className="server-img" src={minecraftAvatarImage} alt="Card image cap"/>
              <div className='server-name'>
            ...
            <li className="list-group-item d-flex">
              <img className="server-img" src={shapeBuilderImage} alt="Card image cap"/>
              <div className='server-name'>
            ...
            <li className="list-group-item d-flex">
              <img className="server-img" src={zeoForestImage} alt="Card image cap"/>
              <div className='server-name'>
